<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="approveList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="提交人" align="center" prop="submitterId" />
      <el-table-column label="审批状态" align="center" prop="status" />
      <el-table-column label="类型与详情" align="center" prop="msg" />
...
<script>
import { listApprove, getApprove, delApprove, addApprove, updateApprove } from "@/api/boa/approve";
